...
class Test extends StatelessWidget {
  ...
  final List<Insta> InstaList = [
    Insta(imguser: 'assets/images/S__25436262.jpg', img: 'assets/images/S__25436280.jpg',
        userpost: 'Zkdlin', comments: [Comments(user: 'nongploy', comment: "so cute"),Comments(user: 'WeAreOne', comment: 'oppa saranghae❤❤❤❤')],
        caption: "Hi❤"),
    Insta(imguser: 'assets/images/S__25436262.jpg', img: 'assets/images/image.jpg',
        userpost: 'Zkdlin', comments: [Comments(user: 'lovejongin', comment: "tasty"),Comments(user: 'nini', comment: "ว๊าวน่ากินมากค่า")],
        caption: "아주 맛있는!!"),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text('KimJongIn',
